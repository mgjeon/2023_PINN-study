...
csvmine = 'ar_series_7115_2017-09-04T00:00:00/energy.csv'
...
csvmine_free = 'ar_series_7115_2017-09-04T00:00:00/free_energy.csv'
...
ax.xaxis.set_major_formatter(mdates.DateFormatter("%Y-%m-%d %H:%M:%S"))
fig.autofmt_xdate()
figure_energy_path = '12673_free_energy.png'
fig.savefig(figure_energy_path, dpi=300)
...
ax.xaxis.set_major_formatter(mdates.DateFormatter("%Y-%m-%d %H:%M:%S"))
fig.autofmt_xdate()
figure_energy_path = '12673_pot_energy.png'
fig.savefig(figure_energy_path, dpi=300)
